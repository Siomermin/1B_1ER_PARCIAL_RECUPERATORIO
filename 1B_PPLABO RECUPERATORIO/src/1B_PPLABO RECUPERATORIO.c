...
eLocalidad listaLocalidades[LEN_LOCALIDADES]={
			{1,"Avellaneda",OCUPADO,1},
			{2,"Lanus",OCUPADO,1},
			{3,"Quilmes",OCUPADO,1},
			{4,"San Isidro",OCUPADO,2},
			{5,"La Matanza",OCUPADO,4},
			{6,"Merlo",OCUPADO,4},
			{7,"Tigre",OCUPADO,2},
			{8,"Pilar",OCUPADO,2}
};
...
pago_inicializar(listaPagos, LEN_PAGOS);
	...
	do
	{
		...
		{
		case 1:
			if(cliente_alta(listaClientes, LEN_CLIENTES, &auxIdCliente, listaLocalidades, LEN_LOCALIDADES, listaZonas, LEN_ZONAS, &auxIdLocalidades) == ERROR) // BIEN
			{
				printf("\nNo fue posible dar de alta el cliente!\n");
			}
			else
			{
				flagAlta = 1;
		...
		case 2:
			if(flagAlta)
			{
				if(cliente_modificar(listaClientes, LEN_CLIENTES, listaLocalidades, LEN_LOCALIDADES, listaZonas, LEN_ZONAS) == FUNCIONO) // BIEN
				{
					printf("\nSe modifico el cliente satisfactoriamente!\n");
				}
				else
				{
			...
			{
				printf("\nSe necesita dar de alta un cliente antes de poder modificarlo!\n");
			}
			break;
		case 3:
			if(flagAlta)
			{
				...
				{
					printf("\nEl cliente se dio de baja satisfactoriamente!\n");
				}
				else
				{
					printf("\nNo fue posible dar de baja el cliente!\n");
				}
			}
			else
			{
				printf("\nSe necesita dar de alta un cliente antes de poder darlo de baja!\n");
			}
			break;
		...
		case 4:
			if(flagAlta)
			{
				...
				{
					printf("\nEl pedido fue creado satisfactoriamente!\n");
					flagPedido = 1;
				}
				else
				{
			...
			{
				printf("\nSe necesita dar de alta un cliente antes de poder crear un pedido!\n");
			}
			break;
		case 5:
			if(flagPedido)
			{
				...
				{
					printf("\nEl pedido fue procesado satisfactoriamente!\n");
					flagProcesados = 1;
				}
				else
				{
			...
			{
				printf("\nSe necesita dar de alta un pedido antes de poder procesarlo!\n");
			}
			break;
		case 6:
			if(flagAlta)
			{
				...
				{
					printf("\nNo fue posible mostrar el listado de clientes!\n");
				}
			}
			else
			{
				printf("\nSe necesita dar de alta un cliente antes de poder mostrarlo!\n");
			}
			break;
		case 7:
			if(flagPedido)
			{
				...
				{
					printf("\nNo fue posible mostrar los pedidos pendientes!\n");
				}
			}
			else
			{
				printf("\nSe necesita dar de alta un pedido antes de poder mostrarlo!\n");
			}
			break;
		case 8:
			if(flagProcesados)
			{
				...
				{
					printf("\nNo fue posible mostrar los pedidos procesados!\n");
				}
			}
			else
			{
				printf("\nSe necesita procesar un pedido antes de poder mostrarlo!\n");
			}
			break;
		case 9:
			if(flagPedido)
			{
				if(informe_pedidosPendientePorLocalidad(listaPedidos, LEN_PEDIDOS, listaClientes, LEN_CLIENTES, listaLocalidades, LEN_LOCALIDADES, listaZonas, LEN_ZONAS) == ERROR)
				{
					printf("\nNo fue posible calcular pedidos pendientes en esa localidad!\n");
				}
			}
			else
			{
		...
		case 10:
			if(flagProcesados)
			{
				...
				{
					printf("\nNo fue posible calcular el promedio de PP del cliente!\n");
				}
			}
			else
			{
		...
		case 11:
			if(flagPedido)
			{
				...
				{
					printf("\nNo fue posible calcular el cliente con mas pedidos pendientes!\n");
				}
			}
			else
			{
		...
		case 12:
			if(flagProcesados)
			{
				...
				{
					printf("\nNo fue posible calcular el cliente con mas pedidos procesados!\n");
				}
			}
			else
			{
			...
			break;
		case 13:
			if(promedio_pagosLiquidadosPorZona(listaClientes, LEN_CLIENTES, listaPedidos, LEN_PEDIDOS, listaLocalidades, LEN_LOCALIDADES, listaPagos, LEN_PAGOS, listaZonas, LEN_ZONAS) == ERROR)
			{
				printf("\nNo fue posible calcular el promedio de pagos liquidados en esa zona!\n");
			}
			break;
		case 14:
			break;
